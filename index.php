...
<head>
    ...
    <title>Andrea Vecchiato Portfolio</title>
    ...
    <link rel="stylesheet" href="scss/layout.scss" type="text/scss">
    <link rel="stylesheet" href="scss/layout.css" type="text/css">
...
<body>
    ...
    <main id="swup" class="transition-fade">
        <div id="fullpage">
            ...
            <?php include "shared/navbar-section1.php"; ?>
            <?php include "shared/biography.php"; ?>
            <?php include "shared/html-css.php"; ?>
            <?php include "shared/bootstrap.php"; ?>
            <?php include "shared/sass.php"; ?>
